      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-lg">
              ...
              <span className="text-gray-700">21-Nov-2025</span>
            </div>
        ...
        <div className="p-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 mb-8">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-2">Revenue is the income that a business has from its normal business activities, usually from the sale of goods and services to customers.</p>
              </div>
              <button className="text-gray-400 hover:text-gray-600">
                <MoreVertical size={20} />
              </button>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mt-2">Sales are activities related to selling or the number of goods or services sold in a given time period.</p>
                </div>
                <button className="text-gray-400 hover:text-gray-600">
                  <MoreVertical size={20} />
                </button>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center">
              <div className="flex justify-between w-full mb-6">
                <h3 className="text-lg font-bold text-gray-900">CLOUD STORAGE</h3>
                <button className="text-gray-400 hover:text-gray-600">
                  <MoreVertical size={20} />
                </button>
              </div>
              <div className="relative w-48 h-48 flex items-center justify-center mb-6">
                <svg className="w-48 h-48" viewBox="0 0 200 200">
                  <circle cx="100" cy="100" r="95" fill="none" stroke="#e5e7eb" strokeWidth="12" />
                  <circle 
                    cx="100" 
                    cy="100" 
                    r="95" 
                    ...
                    stroke="#4f46e5" 
                    strokeWidth="12"
                    strokeDasharray={`${2 * Math.PI * 95 * 0.67} ${2 * Math.PI * 95}`}
                    transform="rotate(-90 100 100)"
                  />
                  <text x="100" y="105" textAnchor="middle" className="text-2xl font-bold fill-gray-900">67%</text>
                </svg>
              </div>
              <p className="text-gray-600 text-sm mb-4">Storage Used</p>
              <button className="bg-red-500 text-white px-6 py-2 rounded-lg hover:bg-red-600 flex items-center gap-2">
                <span>🛒</span>
                Buy Now
              </button>
            </div>
          ...
          <div className="absolute bottom-8 right-8 flex gap-2">
            <button className="px-4 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50">Today</button>
            <button className="px-4 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50">Week</button>
            <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Month</button>
            <button className="px-4 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50">Year</button>
          </div>
        </div>
      </div>
    </div>
